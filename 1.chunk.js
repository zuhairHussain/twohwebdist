...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__lazy_routing__ = __webpack_require__(1411);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_17__start_shopping_start_shopping_component__ = __webpack_require__(1407);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_18__shopping_cart_shopping_cart_component__ = __webpack_require__(1405);
...
var LazyModule = (function () {
    ...
    LazyModule = __decorate([
        __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_2__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_17__start_shopping_start_shopping_component__["a" /* StartShoppingComponent */], __WEBPACK_IMPORTED_MODULE_18__shopping_cart_shopping_cart_component__["a" /* ShoppingCartComponent */]
            ],
            imports: [
...
var ShoppingCartComponent = (function () {
    ...
    ShoppingCartComponent = __decorate([
        __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            ...
            template: __webpack_require__(1426),
            styles: [__webpack_require__(1418)]
        }), 
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return StartShoppingComponent; });
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var StartShoppingComponent = (function () {
    function StartShoppingComponent(spinner, Api, router, formBuilder, navScrollService, _brands) {
        this.spinner = spinner;
        this.Api = Api;
        this.router = router;
    ...
    StartShoppingComponent.prototype.sort = function () {
    ...
    StartShoppingComponent.prototype.getProducts = function () {
        var _this = this;
    ...
    StartShoppingComponent.prototype.onClick = function (item) {
        this.selectedItem = item.name;
        this.productDetails = item;
        this.showNoOfItems = true;
    };
    StartShoppingComponent.prototype.Next = function () {
        this.showMore = true;
    };
    StartShoppingComponent.prototype.EndShopping = function () {
        console.log(this.obj);
    ...
    StartShoppingComponent.prototype.onError401 = function (err) {
        if (err.status === 401) {
            this.spinner.stop();
            console.log('redirect to login');
            // remove user from local storage to log user out
    ...
    StartShoppingComponent.prototype.closeMenu = function () {
        if (document.getElementById('cart-list').style.display != 'none')
            document.getElementById('cart-list').style.display = 'none';
        if (document.getElementById('user-details').style.display != 'none')
            document.getElementById('user-details').style.display = 'none';
    ...
    StartShoppingComponent.prototype.PostMessage = function (obj) {
        var _this = this;
        console.log(obj);
        this.Api.postMessage(obj)
            .subscribe(function (data) {
    ...
    ], StartShoppingComponent.prototype, "contactModal", void 0);
    StartShoppingComponent = __decorate([
        __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'app-start-shopping',
            template: __webpack_require__(1428),
...
//# sourceMappingURL=D:/studio/twohonline/web/src/start-shopping.component.js.map
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__start_shopping_start_shopping_component__ = __webpack_require__(1407);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__shopping_cart_shopping_cart_component__ = __webpack_require__(1405);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return routing; });



var routes = [
    { path: '', component: __WEBPACK_IMPORTED_MODULE_1__start_shopping_start_shopping_component__["a" /* StartShoppingComponent */] },
    { path: 'shopingCart', component: __WEBPACK_IMPORTED_MODULE_2__shopping_cart_shopping_cart_component__["a" /* ShoppingCartComponent */] }
];
